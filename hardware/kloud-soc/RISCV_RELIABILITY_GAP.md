...
- No silicon tapeout.
- Basic simulation regression and bounded formal checks added for bridge path.
- Still no ECC, no lockstep redundancy, and no silicon-level qualification.
...
3. Basic reliability: upset injection, long-run tests, CI regression hardening.
